...
CREATE TABLE Menu (
    ...
    DESCRIPTION TEXT,
    CATEGORY ENUM('Snacks', 'Cold Beverages', 'Vegetarian', 'Non-Vegetarian',
     'Desserts', 'North-Indian', 'South-Indian', 'Chinese', 'Chats', 'Meals') NOT NULL,
...
-- Insert about carousel images
INSERT INTO images (category, item_id, image_path, alt_text) VALUES
('carousel', 'slide1', 'images/carousel/abt_1.jpg', 'Delicious Food Selection'),
('carousel', 'slide2', 'images/carousel/abt_2.jpg', 'Fresh Ingredients'),
('carousel', 'slide3', 'images/carousel/abt_3.jpg', 'Tasty Meals');
...
('Kitchen Staff', 'kitchen@example.com', '9876543211', 'Customer', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1992-05-15'),
('Regular Customer', 'customer@example.com', '9876543212', 'Customer', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1995-08-20');

-- Insert employee records
INSERT INTO Employees (USER_ID, ROLE, SALARY, SHIFT_TIMINGS) VALUES
(1, 'Admin', 50000.00, '9:00 AM - 5:00 PM'),
(2, 'KitchenStaff', 30000.00, '8:00 AM - 4:00 PM');
...
(2, 1, 'Credit Card/Debit Card', 'Completed', 150.00),
(3, 1, 'Credit Card/Debit Card', 'Completed', 200.00),
(4, 1, 'Cash', 'Completed', 120.00),
(5, 1, 'UPI', 'Refunded', 180.00);
